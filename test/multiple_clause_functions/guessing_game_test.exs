defmodule MultipleClauseFunctions.GuessingGameTest do
  use ExUnit.Case
  alias MultipleClauseFunctions.GuessingGame
  ...
  test "test when the atom :no_guess is supplied, ask the player to make a guess" do
