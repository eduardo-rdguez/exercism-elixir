defmodule FlattenArrayTest do
  ...
  @tag :pending
  test "no nesting" do
    assert FlattenArray.flatten([0, 1, 2]) == [0, 1, 2]
  end
  ...
  test "flattens array with just integers present" do
    ...
    assert FlattenArray.flatten([1, [2, 3, 4, 5, 6, 7], 8]) == expected
  end

  @tag :pending
  test "5 level nesting" do
    expected = [0, 2, 2, 3, 8, 100, 4, 50, -2]
    assert FlattenArray.flatten([0, 2, [[2, 3], 8, 100, 4, [[[50]]]], -2]) == expected
  end
